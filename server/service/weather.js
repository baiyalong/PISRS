...
var weatherConfig = JSON.parse(Assets.getText("weather.json"))
weather = {
    appid: weatherConfig.appid,
    private_key: weatherConfig.private_key,
    ...
    getData: function (areaid, type, date) {
        ...
        HTTP.call('GET', url, Meteor.bindEnvironment(function (err, res) {
            if (err || res == null) {
                console.log(url, err)
                Meteor.call('service.err', 'syncWeatherForecast')
