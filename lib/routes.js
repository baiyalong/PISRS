...
FlowRouter.route('/monitor/station', {
    action: () => {
        BlazeLayout.render("layout", { content: "monitor_station" });
    }
});
FlowRouter.route('/monitor/pollutantHourly', {
    action: () => {
        BlazeLayout.render("layout", { content: "monitor_pollutantHourly" });
    }
});
FlowRouter.route('/monitor/pollutantDaily', {
    action: () => {
        BlazeLayout.render("layout", { content: "monitor_pollutantDaily" });
    }
});
...
FlowRouter.route('/config/pollutantLimit', {
    action: () => {
        BlazeLayout.render("layout", { content: "config_pollutantLimit" });
    }
});
...
FlowRouter.route('/config/IPtrustList', {
    action: () => {
        BlazeLayout.render("layout", { content: "config_IPtrustList" });
    }
});
FlowRouter.route('/config/dataIO', {
    action: () => {
        BlazeLayout.render("layout", { content: "config_dataIO" });
    }
});
